    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
            ...
            <div
                ...
                style={{
                    backgroundImage: `
            linear-gradient(rgba(255,107,74,0.08) 1px, transparent 1px),
            linear-gradient(90deg, rgba(255,107,74,0.08) 1px, transparent 1px)
          `,
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-16">
                <div className="max-w-3xl">
                    ...
                    <motion.div {...fadeUp(0.1)}>
                        <span className="inline-block font-mono text-xs tracking-[0.25em] uppercase text-coral border border-coral/30 px-4 py-1.5 mb-8 bg-background/50 backdrop-blur-sm relative z-20">
                    ...
                    <motion.h1
                        {...fadeUp(0.25)}
                        className="font-playfair font-black leading-[0.95] mb-6 relative z-20"
                    ...
                    <motion.p
                        {...fadeUp(0.4)}
                        className="text-charcoal/60 text-lg md:text-xl font-light max-w-xl leading-relaxed mb-6 relative z-20"
                    >
                        I don't just read markets — I map them, question them,
                    ...
                    <motion.blockquote
                        {...fadeUp(0.55)}
                        className="border-l-2 border-gold pl-5 mb-10 max-w-lg relative z-20"
                    >
                    ...
                    >
                        {[
                            ...
                            <span
                                key={chip}
                                className="font-mono text-xs tracking-wide text-teal bg-teal/5 border border-teal/20 px-3 py-1 backdrop-blur-sm"
                            >
                                {chip}
                            </span>
                        ))}
            ...
            >
                <span className="font-mono text-xs tracking-widest uppercase text-charcoal/30">
                    Scroll
                </span>
                <motion.div
                    animate={{ y: [0, 8, 0] }}
